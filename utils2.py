...
from hmr2.src.main.config import Config
from hmr2.src.main.model import Model
from hmr2.src.main.dataset import Dataset
from hmr2.src.main.smpl import Smpl
from hmr2.src.main.local import LocalConfig

from hmr2.src.visualise.vis_util import draw_2d_on_image, show_2d_pose, show_3d_pose, preprocess_image, resize_img, visualize
...
def process(ht,seg_model,hmr_model):
  start_top = time.time()
  ## Parameters ##
